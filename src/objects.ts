...
export function isCorrect(question: Question, answer: string): boolean {
    return question.expected.toLocaleLowerCase().trim() === answer.toLocaleLowerCase().trim()
}
...
export function isValid(question: Question, answer: string): boolean {
    let validAnswer = question.options.some((option: string): boolean => option === answer)
    return (question.type === "multiple_choice_question" && validAnswer) || question.type === "short_answer_question" ? true: false
}
...
export function mergeQuestion(
    ...
    return {id, name, body: contentQuestion.body, type: contentQuestion.type, options: contentQuestion.options, expected: contentQuestion.expected, points: points, published: false};
}
